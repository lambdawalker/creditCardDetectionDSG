from scripts.templates.generators.fields.field_generators import generate_credit_card, generate_payment_network_logo, get_random_bank, get_random_card_name, get_random_card_phrase, get_random_flavor, \
...
field_generators = {
    ...
    "paymentNetworkName": generate_payment_network_logo,
